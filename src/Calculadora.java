    ...
    public static void main(String[] args) {
        ...
        switch (operacion) {
            ...
            case '%':
                ...
                System.out.println("El resultado del modulo entre " + numero1 + " y " + numero2 + " es: " + modulo);
                break;
            case '^':
                //Operación potencia:
                double potencia = Math.pow(numero1, numero2);
                System.out.print("El resultado de la potencia entre " + numero1 + " y " + numero2 + " es: " + potencia);
                break;
            default:
